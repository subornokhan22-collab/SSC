...
/// English (Compulsory)–Second Paper উত্তরমালা (এক সেট)
class SecondPaperAns {
  final List<String> q1; // (a)–(j) fill-in-the-gaps উত্তর
  final List<String> q2; // (a)–(e) মিলিয়ে-বানানো পাঁচটি বাক্য
  final List<String> q3; // (a)–(j) right form of verbs
  final List<String> q4; // (a)–(j) changed sentences
  final List<String> q5; // (a)–(e) tag questions
...
/// English (Compulsory)–First Paper উত্তরমালা (এক সেট)
class FirstPaperAns {
  final List<String> q1; // (a)–(g) MCQ সঠিক অপশন
...
/// যাচাই: মোট ৯ + ৯ = ১৮ সেটের উত্তর
const int englishAnswerSetCount2024 = 18;
