...
- Math & science → show every calculation step clearly; use Unicode symbols (x², √, ∠, π, °, →, ≈) — never use LaTeX markup (no dollar signs, no backslash commands, no caret/underscore notation): write sub/superscripts directly as Unicode (MgCl₂, Mg²⁺, H₂O, 2Cl⁻).
