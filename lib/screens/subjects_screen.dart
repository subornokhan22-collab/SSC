...
const List<SubjectInfo> allSubjects = [
  ...
  SubjectInfo(
      ...
      icon: '🔬',
      colorHex: 0xFF00695C,
      group: SubjectGroup.business), // 127
  SubjectInfo(
      id: 'agriculture',
      name: 'Agriculture',
      ...
      icon: '🌾',
      colorHex: 0xFF33691E,
      group: SubjectGroup.business), // 134 – 50 theory +25 MCQ +25 practical
  SubjectInfo(
      id: 'business_ent',
      name: 'Business Entre.',
      ...
      icon: '💼',
      colorHex: 0xFF4A148C,
      group: SubjectGroup.business), // 143
  SubjectInfo(
      id: 'accounting',
      name: 'Accounting',
      ...
      icon: '📊',
      colorHex: 0xFFE65100,
      group: SubjectGroup.business), // 146 – special compulsory
  SubjectInfo(
      id: 'finance',
      ...
      icon: '🏦',
      colorHex: 0xFF1B5E20,
      group: SubjectGroup.business), // 152 – finance division quota
  SubjectInfo(
      id: 'ict',
      name: 'ICT',
      ...
      colorHex: 0xFF00796B,
      group: SubjectGroup
          .general), // 154 – New 2025 circular: MCQ 25 only + 25 practical =50
  SubjectInfo(
      id: 'physical_edu',
      ...
      icon: '⚽',
      colorHex: 0xFFBF360C,
      group: SubjectGroup.general), // 147 – continuous 50
  SubjectInfo(
      id: 'career',
      ...
      icon: '🎯',
      colorHex: 0xFF3E2723,
      group: SubjectGroup.general), // 156 – continuous 50
