  ...
  static Route<dynamic>? generate(RouteSettings route){
    ...
    switch(route.name){
      case createPaper:
        ...
        screen=CreatePaperScreen(initialSubjectId:a?.subjectId,initialFormat:a?.format,initialQuestions:a?.questions);
        break;
      case settings:screen=const SettingsScreen();break;
      case plans:screen=const SubscriptionScreen();break;
      case ai:screen=const AiToolsScreen();break;
      default:return null;
    }
